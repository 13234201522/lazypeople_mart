<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/www/wwwroot/lazypeople_mart/public/../application/admin/view/user/user/edit.html";i:1601304741;s:71:"/www/wwwroot/lazypeople_mart/application/admin/view/layout/default.html";i:1588765311;s:68:"/www/wwwroot/lazypeople_mart/application/admin/view/common/meta.html";i:1588765311;s:70:"/www/wwwroot/lazypeople_mart/application/admin/view/common/script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Leveltime'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-leveltime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[leveltime]" type="text" value="<?php echo $row['leveltime']?datetime($row['leveltime']):''; ?>">
        </div>
    </div>
<!--    <div class="form-group">-->
