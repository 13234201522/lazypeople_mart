<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/lazypeople_mart/public/../application/admin/view/goods/add.html";i:1607656979;s:71:"/www/wwwroot/lazypeople_mart/application/admin/view/layout/default.html";i:1588765311;s:68:"/www/wwwroot/lazypeople_mart/application/admin/view/common/meta.html";i:1588765311;s:70:"/www/wwwroot/lazypeople_mart/application/admin/view/common/script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <!--        <input id="c-category_id" data-rule="required" data-source="category/selectpage?isTree=1&ishtml=1" data-order-by='weigh desc' class="form-control selectpage" name="row[category_id]" type="text" value="">-->
    <!--    </div>-->
    <!--</div>-->
    
    <div class="form-group">
        <label for="c-parent_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Category_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            ...
            <script id="basictpl" type="text/html">
                <dd class="form-inline options"  style="display: flex;justify-content: flex-start;">
                    <div  style="width: 90%;display: flex;justify-content: space-between;">
                        <ins >
                            <input type="text" data-rule="required" name="<%=name%>[<%=index%>][specs]" class="form-control" placeholder="规格">
                        </ins>
                        <ins>
                            <input type="number" data-rule="required" name="<%=name%>[<%=index%>][price]" class="form-control" placeholder="价格">
                        </ins>
                        <ins>
                            <input type="number" data-rule="required" name="<%=name%>[<%=index%>][stock]" class="form-control"  placeholder="库存">
                        </ins>
                        <ins>
                            <div class="input-group">
                                <input id="c-image-<%=index%>" data-rule="required" class="form-control" name="<%=name%>[<%=index%>][specs_image]" type="textarea">
                                <div class="input-group-addon no-border no-padding">
                            ...
                            <ul class="row list-inline plupload-preview imgurl" style="" id="p-image-<%=index%>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-hot_switch" name="row[hot_switch]" type="hidden" value="0">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-vip_switch" name="row[vip_switch]" type="hidden" value="0">
...
<!--            <input  id="c-fullcut_switch" name="row[fullcut_switch]" type="hidden" value="0">-->
