<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/www/wwwroot/lazypeople_mart/public/../application/admin/view/category/edit.html";i:1597291460;s:71:"/www/wwwroot/lazypeople_mart/application/admin/view/layout/default.html";i:1588765311;s:68:"/www/wwwroot/lazypeople_mart/application/admin/view/common/meta.html";i:1588765311;s:70:"/www/wwwroot/lazypeople_mart/application/admin/view/common/script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]">
                ...
                <option data-type="" class="" value="<?php echo $vo['id']; ?>" <?php if(in_array(($key), is_array($row['pid'])?$row['pid']:explode(',',$row['pid']))): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
