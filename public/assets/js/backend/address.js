define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'link_mobile', title: __('Link_mobile')},
                        {field: 'province', title: __('Province')},
                        // {field: 'province_place_id', title: __('Province_place_id')},
                        {field: 'city', title: __('City')},
                        // {field: 'city_place_id', title: __('City_place_id')},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'address/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
